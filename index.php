...
if ($path === 'products' || str_starts_with($path, 'products/')) {
    ...
    render_start($slug ? 'Product detail' : 'Products'); ?>
        <section class="section"><div class="container"><p class="eyebrow">Material systems</p><h1 class="display-3 mb-5">High-Performance Bioplastics for a<br>Better Future.</h1>
