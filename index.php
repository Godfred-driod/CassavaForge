...
if ($path === 'products' || str_starts_with($path, 'products/')) {
    ...
    <section class="section"><div class="container"><p class="eyebrow">Material systems</p><h1 class="display-3 mb-5">Products designed<br>for the next cycle.</h1>
...
if ($path === 'blog' || str_starts_with($path, 'blog/')) {
    ...
    <section class="section"><div class="container"><p class="eyebrow">Field notes</p><h1 class="display-3 mb-5">The material<br>behind the movement.</h1><?php if ($slug && !empty($posts[0])): $post = $posts[0]; ?><article style="max-width:800px"><p class="eyebrow"><?= e($post['category']) ?></p><h2 class="display-5"><?= e($post['title']) ?></h2><p class="lead"><?= e($post['excerpt']) ?></p><div class="mt-5" style="white-space:pre-line"><?= e($post['content']) ?></div></article><?php else: ?><div class="row g-4"><?php foreach ($posts as $post): ?><div class="col-md-6"><article class="card h-100 p-4"><p class="eyebrow"><?= e($post['category']) ?></p><h2><?= e($post['title']) ?></h2><p><?= e($post['excerpt']) ?></p><a class="btn btn-sm btn-outline-dark sans" href="<?= e(url('blog/' . $post['slug'])) ?>">Read article</a></article></div><?php endforeach; ?></div><?php if (!$posts): ?><p class="sans">Journal posts will appear here after the MySQL seed data is imported.</p><?php endif; ?><?php endif; ?></div></section>
    <?php render_end(); exit;
}

$static = [
    '' => ['Home', '<section class="hero py-5"><div class="container py-5"><p class="eyebrow">Plant-based materials, engineered for real life</p><h1 class="my-4">Better materials<br>begin at the root.</h1><p class="lead col-lg-7">CassavaForge turns renewable cassava starch into practical, high-performance alternatives for packaging, films, and molded products.</p><a class="btn btn-light btn-lg sans mt-3" href="' . e(url('products')) . '">Explore materials</a></div></section><section class="section"><div class="container"><div class="row g-5"><div class="col-md-6"><p class="eyebrow">A different starting point</p><h2 class="display-5">We make the useful choice easier.</h2></div><div class="col-md-6"><p class="lead">Our work connects agricultural potential with the exacting demands of modern product design. Every material starts with a better question: what should happen after use?</p></div></div></div></section>'],
    'about' => ['About', '<section class="section"><div class="container"><p class="eyebrow">Our approach</p><h1 class="display-3">Grown locally.<br>Thought globally.</h1><div class="row mt-5 g-5"><div class="col-md-6"><p class="lead">Cassava grows well in African climates, supports local farmers, and provides a reliable, low-cost source of starch for bioplastic production.</p></div><div class="col-md-6"><p>We bring material science, responsible sourcing, and product design into the same conversation. That means fewer compromises between performance and progress.</p></div></div></div></section>'],
    'impact' => ['Impact', '<section class="section"><div class="container"><p class="eyebrow">Measure what matters</p><h1 class="display-3">Progress should<br>leave evidence.</h1><div class="row mt-5 g-4"><div class="col-md-4"><div class="stat"><strong class="display-5">01</strong><p class="mt-3">Renewable feedstocks with traceable origins.</p></div></div><div class="col-md-4"><div class="stat"><strong class="display-5">02</strong><p class="mt-3">Performance tested against real use cases.</p></div></div><div class="col-md-4"><div class="stat"><strong class="display-5">03</strong><p class="mt-3">Partnerships that move ideas into production.</p></div></div></div></div></section>'],
    'contact' => ['Contact', '<section class="section"><div class="container"><div class="row g-5"><div class="col-md-5"><p class="eyebrow">Let us build something useful</p><h1 class="display-4">Bring us a material problem.</h1><p class="lead mt-4">Tell us what you are making, what it needs to do, and where the current options fall short.</p></div><div class="col-md-7">' . (($message = flash()) ? '<div class="alert alert-success sans">' . e($message) . '</div>' : '') . '<form method="post" class="card p-4"><input type="hidden" name="csrf" value="' . e(csrf_token()) . '"><label class="form-label sans">Name</label><input class="form-control mb-3" name="full_name" maxlength="200" required><label class="form-label sans">Email</label><input class="form-control mb-3" type="email" name="email_address" maxlength="254" required><label class="form-label sans">Message</label><textarea class="form-control mb-4" name="message_body" maxlength="5000" rows="6" required></textarea><button class="btn btn-primary sans" type="submit">Send inquiry</button></form></div></div></div></section>'],
];
